...
ActiveRecord::Schema.define(version: 2020_11_09_173007) do
  ...
  create_table "course_students", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "student_id"
    t.bigint "course_id"
